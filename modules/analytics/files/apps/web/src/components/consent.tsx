...
export function Consent() {
  ...
  useEffect(() => {
    if (choice === "accepted") analytics.track("page.viewed", { path });
  }, [choice, path]);
  ...
  return (
    <aside className="consent-bar" aria-label="Analytics consent">
      <p>May we use optional analytics to understand site visits?</p>
      <div>
        <Button onClick={() => choose("accepted")}>Allow</Button>
