...
Run `pnpm verify` after generator or template changes; it checks the factory, marketing fixture, PostgreSQL migration, browser journeys, and container. Docker must be running. Record completed gates in `docs/build-progress.md`.
