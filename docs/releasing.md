...
Stackiln uses Semantic Versioning. Until the package surfaces are compiled and publishable, releases are source releases on GitHub and the workspace packages remain private.
...
3. Update the root and package versions, `stackilnVersion`, `CITATION.cff`, and generated fixtures together.
