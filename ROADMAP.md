...
- Billing and entitlements, organisations and RBAC, usage and API products, jobs and webhooks, storage, commerce, marketplace, and notifications.
- A wider fixture matrix and migration tests across released schema versions.

Detailed implementation evidence is maintained in [docs/build-progress.md](docs/build-progress.md). Propose roadmap changes through an issue before investing in a large implementation.
